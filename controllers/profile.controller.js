...
const getProfile = async (req, res) => {
  try {
    ...
    let sql = 'SELECT user.id, user.name, user.email, profile.birthday, user.photo, profile.gender, profile.weight, profile.height, profile.activity_level, user.registered_at FROM user JOIN profile ON (profile.user_id = user.id) WHERE user.id = ?';
